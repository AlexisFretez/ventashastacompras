...
INSERT IGNORE INTO `categorias` (`id`, `nombre`, `descripcion`, `estado`) VALUES
	(7, 'Televisores', 'de 32 pulgadas', 0),
	(8, 'Computadoras', 'PCS', 0);
...
-- Volcando datos para la tabla ventas_ci.clientes: ~9 rows (aproximadamente)
...
INSERT IGNORE INTO `detalle_venta` (`id`, `producto_id`, `venta_id`, `precio`, `cantidad`, `importe`) VALUES
	(37, 12, 27, '2000000', '2', '4000000.00');
...
INSERT IGNORE INTO `productos` (`id`, `codigo`, `nombre`, `descripcion`, `precio`, `stock`, `categoria_id`, `estado`) VALUES
	(11, '01', 'Televisor Midas', 'midas ', '1000000', 20, 7, 1),
	(12, '02', 'Notebook Acer', 'Acer', '2000000', 8, 8, 1);
...
INSERT IGNORE INTO `ventas` (`id`, `fecha`, `subtotal`, `igv`, `descuento`, `total`, `tipo_comprobante_id`, `cliente_id`, `usuario_id`, `num_documento`, `serie`) VALUES
	(27, '2019-04-12', '4000000.00', '0.00', '0.00', '4000000.00', 2, 11, 3, '000012', '1');
