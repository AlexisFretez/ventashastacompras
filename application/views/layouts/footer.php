...
$(document).ready(function () {
    ...
    $(".btn-view-proveedor").on("click", function(){
        ...
        html = "<p><strong>Nombre:</strong>"+infoproveedpr[1]+"</p>"
        html += "<p><strong>Numero Documento:</strong>"+infoproveedpr[2]+"</p>"
        html += "<p><strong>Direccion:</strong>"+infoproveedpr[3]+"</p>"
        html += "<p><strong>Telefono:</strong> <big>"+infoproveedpr[4]+"</big></p>"
        //html += "<p><strong>Stock:</strong>"+infoproveedpr[5]+"</p>"
