                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>mantenimiento/productos"><i class="fa fa-product-hunt"></i> Productos</a></li>
                             <li><a href="<?php echo base_url(); ?>mantenimiento/proveedores"><i class="fa fa-product-hunt"></i> Proveedores</a></li>
